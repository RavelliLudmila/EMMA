...
('Carlos',   'Rodríguez', '20-12345678-9', '3425001111', 'carlos.rodriguez@mail.com', 'Bv. Gálvez 1200, Santa Fe', false),
('María',    'López',     '27-23456789-0', '3425002222', 'maria.lopez@mail.com',      'San Martín 450, Santa Fe',   false),
('Roberto',  'Gómez',     '20-34567890-1', '3425003333', 'roberto.gomez@mail.com',    'Rivadavia 800, Santo Tomé',  false),
('Ana',      'Fernández', '27-45678901-2', '3425004444', 'ana.fernandez@mail.com',    'Urquiza 320, Santa Fe',      false),
('Diego',    'Martínez',  '20-56789012-3', '3425005555', 'diego.martinez@mail.com',   '25 de Mayo 600, Santa Fe',   false);

-- Propiedades
INSERT INTO propiedad (direccion, ciudad, tipo, cantidad_ambientes, metros_cuadrados, descripcion, estado_disponibilidad, propietario_id, eliminado) VALUES
('Rivadavia 1500', 'Santa Fe',   'CASA',         4, 120.0, 'Casa con jardín y cochera.',         'ALQUILADA',  1, false),
('San Martín 200', 'Santo Tomé', 'DEPARTAMENTO', 2,  55.0, 'Departamento 2 ambientes, 3er piso.','DISPONIBLE', 2, false),
('Belgrano 750',   'Santa Fe',   'LOCAL',        1,  80.0, 'Local comercial en planta baja.',    'DISPONIBLE', 1, false);
...
UPDATE factura SET
    fecha_pago = '2025-01-03',
    medio_pago = 'TRANSFERENCIA',
    importe_pagado = 150000.00,
    interes = 0.00
WHERE id = 1;
